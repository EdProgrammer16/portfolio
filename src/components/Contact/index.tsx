    ...
    <div className='w-full px-[23px] md:py-20 py-16 bg-[#f6f6f6] relative z-[100]'>
        <div className='flex w-full md:flex-row flex-col items-center justify-center gap-16 p-16'>
            ...
            <div className='flex flex-col gap-6'>
                <span className='text-orange-600 opacity-[0.06] md:text-8xl text-5xl font-semibold'>
                    CONTACT ME
                </span>
                <form action='#'>
                ...
                <button className="text-white rounded-full bg-orange-500 hover:bg-orange-600 transition-all duration-300 w-fit px-5 py-3 font-medium">Enviar Mensagem</button>
            </div>
        </div>
    </div>
  );
